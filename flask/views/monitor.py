...
from const import key_file, rssh_ip, rssh_port, server_files_path, log_path, supershell_version_dict
...
def get_supershell_version_info():
    '''
        获取Supershell版本信息
    '''
    supershell_version_result = getSupershellVersionInfo(supershell_version_dict)
